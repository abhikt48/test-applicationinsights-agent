...
public class TestAiWithMultiTransportsSameThread implements MessageListener, ExceptionListener{
	...
	public static void main(String[] args) throws Exception {
		...
		TestAiWithMultiTransportsSameThread test = new TestAiWithMultiTransportsSameThread();
